...
<div class = "w-full">
  ...
  <form method="POST" action="{{ route('login') }}">
    ...
    <div class="flex justify-center mt-8">
      <button class="group flex h-18 w-18 select-none items-center justify-center rounded-full border border-black border-zinc-100 bg-white leading-8 text-zinc-950 shadow-[0-1px_0_0px#d4d4d8inset,0_0_0_1px#f4f4f5inset,0_0.5px_0_1.5px#fffinset] hover:bg-zinc-50 hover:via-zinc-900 hover:to-zinc-800 active:shadow-[-1px_0px_1px_0px#e4e4e7inset,1px_0px_1px_0px#e4e4e7inset,0px_0.125rem_1px_0px#d4d4d8_inset]" aria-label="Change language" style="height: 4.5rem; width: 4.5rem;">
