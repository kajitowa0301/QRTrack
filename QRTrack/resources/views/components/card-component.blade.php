<div class="my-3 mx-auto">
    ...
    <a href="{{route('postShow', $data->posts_id)}}">
     ...
     sm:w-52 sm:mx-auto xs:w-44 xs:mx-auto">
            <img class="w-64 h-64;lg:w-60 h-60; md:w-52 h-52; sm:w-52 sm:h-52" src="{{Storage::disk('s3')->url('https://qrtrackbucket.s3.ap-northeast-1.amazonaws.com/'.$data->image_path)}}"
                alt="">
