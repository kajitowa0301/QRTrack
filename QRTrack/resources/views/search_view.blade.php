...
<body class="w-full gra">
  ...
  @endif
  <form method = "POST" action = "{{ route('search') }}" class="my-4 flex justify-center xl:hidden">
    @csrf
      <input type = "text" name = "keyword" class="border-2 border-gray-400 rounded-lg w-9/12 mr-10" placeholder="🔍Search...">
